load(file= "raw_spectra.rda")
load(file= "white_standard.rda")
load(file= "wavelength.rda")

spectra<- raw_spectra
avg.standard<- white_standard
...
Xnames<- paste0("X", colnames(spectral_database[,-c(1:2)]))
